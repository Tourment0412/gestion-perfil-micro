package com.uniquindio.archmicroserv.gestion_perfil.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePerfilNotFound(PerfilNotFoundException ex) {
